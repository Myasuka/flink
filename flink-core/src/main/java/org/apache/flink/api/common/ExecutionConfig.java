...
public class ExecutionConfig implements Serializable, Archiveable<ArchivedExecutionConfig> {
	...
	/**
	 * @deprecated Should no longer be used because we would not support to let task fail on checkpoint error.
	 */
	@Deprecated
	 ...
	 * to the task. We have not supported task to fail on checkpoint error.
	 */
	@Deprecated
	@Internal
