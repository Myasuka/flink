...
public class RocksDBAccessMetricTest {
	...
	public void testRocksDBAccessMetricBuilderFromConfig() {
		...
		assertEquals((int) RocksDBOptions.LATENCY_TRACK_SAMPLE_INTERVAL.defaultValue(), dbAccessMetric.getSampleCountInterval());
		assertEquals((long) RocksDBOptions.LATENCY_TRACK_SLIDING_WINDOW.defaultValue(), dbAccessMetric.getHistogramWindowSize());
